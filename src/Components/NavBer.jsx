        ...
        <Container>
            <nav className='py-4 lg:py-0 border-b-1 border-[##ADADAD] '>
                <Flex className="justify-between !flex-nowrap lg:!justify-start items-center relative">
                    ...
                    <div className={`${navber?  "top-20  bg-blue-400 lg:bg-white z-10" :"top-20 left-[-500px]"} lg:flex justify-between  w-full space-y-3.5 lg:static absolute  left-0  rounded-2xl p-5 transition-all duration-1000`}>
