        ...
        <div className='bg-primary rounded-xl  px-10 lg:pl-[70px]'>
            <Flex className="items-end flex-wrap-reverse">
                <div className='py-[60px]  lg:pt-[100px] lg:pb-[158px] '>
                    <h1 className='text-[40px] md:text-[40px] lg:text-[63px] font-semibold font-Outfit leading-15 lg:leading-[80px] text-white'>Book Appointment <br /> With Trusted Doctors</h1>
